...
A modern, responsive, progressive web application (PWA) designed for tracking equipment, accessories, multi-item team allocations, returns, defect logs, lost items, box kit components, inter-set transfers, and automated stock calculations. Equipped with **real-time Firebase Cloud Database synchronization** across mobile phones and desktop laptops.

---

## 🚀 Quick Links & Deployment

- **🌐 Live Production Website:** [https://asset-management-app-sable.vercel.app](https://asset-management-app-sable.vercel.app)
- **💻 GitHub Repository:** [https://github.com/assetmanagement236-dev/AssetManagement](https://github.com/assetmanagement236-dev/AssetManagement)
- **🏷️ Official GitHub Release:** [https://github.com/assetmanagement236-dev/AssetManagement/releases/tag/v1.0.0](https://github.com/assetmanagement236-dev/AssetManagement/releases/tag/v1.0.0)
...
1. Open [https://asset-management-app-sable.vercel.app](https://asset-management-app-sable.vercel.app) on your Android mobile browser.
...
1. Open [https://asset-management-app-sable.vercel.app](https://asset-management-app-sable.vercel.app) in **Safari**.
...
2. Data changes (Adding items, issuing gear, returning equipment, reporting lost gear, inter-set transfers) trigger background batch updates to Firestore.
...
- **Master Inventory & Box Set Components:** Serialized main equipment tracking with custom box accessories (Batteries, Chargers, Cases) attached to kit sets.
- **Set Integrity Status:** Automated monitoring showing `COMPLETE SET` or warning `INCOMPLETE SET` badges when accessories are missing or borrowed.
- **Inter-Set Accessory Borrow & Transfer:** Borrow specific box accessories from one equipment set and assign them to another with real-time tracking and return options.
...
- **Formatted CSV Export & Backup Workflow:** Export full monthly inventory reports with dynamic timestamp filenames (`Asset_Backup_YYYY-MM-DD_HH-mm.csv`) including inter-set transfer histories.
...
_Developed for company equipment & asset tracking._
